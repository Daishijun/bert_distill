...
if __name__ == '__main__':
    ...
    newmodel.load_state_dict(torch.load('../data/cache/resaved_params_sig_weightedpos.pth', map_location=torch.device('cpu')))
    print('load ok')

    print('save to cpu')
    torch.save(obj=newmodel.state_dict(), f='../data/cache/cpucache/resaved_params_sig_weightedpos.pth')
